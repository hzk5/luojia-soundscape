package com.luojia.soundscape.common.constant;

public class RedisConstant {

    public static final String ALBUM_INFO_PREFIX = "album:info:";
    public static final String ALBUM_DETAIL_PREFIX = "album:detail:";
    public static final String SEARCH_CHANNEL_PREFIX = "search:channel:";
    public static final String SEARCH_ITEM_PREFIX = "search:item:";
    public static final String SEARCH_QUERY_PREFIX = "search:query:";
    ...
    public static final String RANKING_SNAPSHOT_PREFIX = "ranking:snapshot:";
    public static final String RANKING_SNAPSHOT_ACTIVE = "ranking:snapshot:active";
