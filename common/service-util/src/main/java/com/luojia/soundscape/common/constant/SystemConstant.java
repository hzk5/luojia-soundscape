...
public class SystemConstant {
    ...
    public static final String TRACK_STATUS_MANUAL = "0503";  // 人工审核
    public static final String TRACK_STATUS_REVIEWING = "0504";  // 音频文件机审中
    ...
    //订单/充值 状态 0901-正常 0902-已支付 0903-已取消
    ...
    public static final String ORDER_ITEM_TYPE_VIP_PRO = "1004";  // 超级vip会员
    ...
    public static final String PAYMENT_STATUS_CANCEL = "1403";  // 已取消
