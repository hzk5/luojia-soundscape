-- Luojia Soundscape Nacos persistence schema
-- Configuration rows and default login credentials are intentionally omitted.

CREATE DATABASE IF NOT EXISTS `luojia_soundscape_nacos`
  DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `luojia_soundscape_nacos`;
